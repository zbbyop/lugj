...
[ ! -f feeds.conf ] && {
sed -i '$a src-git kiddin9 https://github.com/byopw/oprj.git;master' feeds.conf.default
}
...
sed -i "s/192.168.0/192.168.0/" package/feeds/kiddin9/base-files/files/bin/config_generate
